...
const LESSON_CONTENT = {
  'Die türkischen Sonderbuchstaben': {
    ...
    nachsprech: [
      ...
      { tr: 'şeker',   de: 'Zucker',        audio: 'audio/seker.mp3' },
      { tr: 'güzel',   de: 'schön',         audio: 'audio/guzel.mp3' },
      { tr: 'lütfen',  de: 'bitte',         audio: 'audio/lutfen.mp3' },
      { tr: 'değil',   de: 'nicht',         audio: 'audio/degil.mp3' },
      { tr: 'öğrenci', de: 'Schüler/in',    audio: 'audio/ogrenci.mp3' },
      { tr: 'dağ',     de: 'Berg',          audio: 'audio/dag.mp3' },
      { tr: 'kız',     de: 'Mädchen',       audio: 'audio/kiz.mp3' },
    ],
  ...
  'Vokale & Vokalharmonie': {
    ...
    nachsprech: [
      { tr: 'ada',     de: 'Insel',       audio: 'audio/ada.mp3' },
      { tr: 'ev',      de: 'Haus',        audio: 'audio/ev.mp3' },
      { tr: 'ışık',    de: 'Licht',       audio: 'audio/isik.mp3' },
      { tr: 'okul',    de: 'Schule',      audio: 'audio/okul.mp3' },
      { tr: 'öğrenci', de: 'Schüler/in',  audio: 'audio/ogrenci.mp3' },
      { tr: 'uçak',    de: 'Flugzeug',    audio: 'audio/ucak.mp3' },
      { tr: 'üzüm',    de: 'Traube',      audio: 'audio/uzum.mp3' },
      { tr: 'araba',   de: 'Auto',        audio: 'audio/araba.mp3' },
    ],
  ...
  'Aussprache-Training': {
    ...
    nachsprech: [
      { tr: 'çikolata',  de: 'Schokolade',  audio: 'audio/cikolata.mp3' },
      { tr: 'şehir',     de: 'Stadt',        audio: 'audio/sehir.mp3' },
      { tr: 'öğretmen',  de: 'Lehrer/in',    audio: 'audio/ogretmen.mp3' },
      { tr: 'büyük',     de: 'groß',         audio: 'audio/buyuk.mp3' },
      { tr: 'küçük',     de: 'klein',        audio: 'audio/kucuk.mp3' },
      { tr: 'kız',       de: 'Mädchen',      audio: 'audio/kiz.mp3' },
      { tr: 'yavaş',     de: 'langsam',      audio: 'audio/yavas.mp3' },
      { tr: 'hızlı',     de: 'schnell',      audio: 'audio/hizli.mp3' },
    ],
  ...
  'Hallo & Tschüss': {
    ...
    nachsprech: [
      { tr: 'Merhaba',       de: 'Hallo',                   audio: 'audio/merhaba.mp3' },
      { tr: 'Günaydın',      de: 'Guten Morgen',            audio: 'audio/gunaydin.mp3' },
      { tr: 'İyi günler',    de: 'Guten Tag',               audio: 'audio/iyi_gunler.mp3' },
      { tr: 'İyi akşamlar',  de: 'Guten Abend',             audio: 'audio/iyi_aksamlar.mp3' },
      { tr: 'Hoşça kal',     de: 'Tschüss (ich gehe)',      audio: 'audio/hosca_kal.mp3' },
      { tr: 'Güle güle',     de: 'Tschüss (du gehst)',      audio: 'audio/gule_gule.mp3' },
      { tr: 'Görüşürüz',     de: 'Bis bald',                audio: 'audio/gorusuruz.mp3' },
      { tr: 'İyiyim',        de: 'Mir geht\'s gut',         audio: 'audio/iyiyim.mp3' },
    ],
  ...
  'Bitte & Danke': {
    ...
    nachsprech: [
      ...
      { tr: 'Lütfen',          de: 'Bitte',                    audio: 'audio/lutfen.mp3' },
      { tr: 'Rica ederim',     de: 'Gern geschehen',           audio: 'audio/rica_ederim.mp3' },
      { tr: 'Sağ ol',          de: 'Danke',                    audio: 'audio/sag_ol.mp3' },
      { tr: 'Bir şey değil',   de: 'Nichts zu danken',         audio: 'audio/bir_sey_degil.mp3' },
      { tr: 'Özür dilerim',    de: 'Entschuldigung',           audio: 'audio/ozur_dilerim.mp3' },
      { tr: 'Affedersiniz',    de: 'Entschuldigung / Verzeihung', audio: 'audio/affedersiniz.mp3' },
      { tr: 'Buyurun',         de: 'Bitte sehr',               audio: 'audio/buyurun.mp3' },
    ],
  ...
  'Ja, Nein, Ich verstehe nicht': {
    ...
    nachsprech: [
      { tr: 'Evet',                   de: 'Ja',                              audio: 'audio/evet.mp3' },
      { tr: 'Hayır',                  de: 'Nein',                            audio: 'audio/hayir.mp3' },
      { tr: 'Tamam',                  de: 'OK / Alles klar',                 audio: 'audio/tamam.mp3' },
      { tr: 'Anlamıyorum',            de: 'Ich verstehe nicht',              audio: 'audio/anlamiyorum.mp3' },
      { tr: 'Bilmiyorum',             de: 'Ich weiß nicht',                  audio: 'audio/bilmiyorum.mp3' },
      { tr: 'Ne demek?',              de: 'Was bedeutet das?',               audio: 'audio/ne_demek.mp3' },
      { tr: 'Tekrar eder misiniz?',   de: 'Können Sie wiederholen?',         audio: 'audio/tekrar_eder_misiniz.mp3' },
      { tr: 'Yavaş konuşur musunuz?', de: 'Können Sie langsamer sprechen?',  audio: 'audio/yavas_konusur_musunuz.mp3' },
    ],
  ...
  'Mein Name ist...': {
    ...
    nachsprech: [
      { tr: 'Benim adım',          de: 'Mein Name ist',              audio: 'audio/benim_adim.mp3' },
      { tr: 'Adın ne?',            de: 'Wie heißt du?',              audio: 'audio/adin_ne.mp3' },
      { tr: 'Ben',                 de: 'Ich',                        audio: 'audio/ben.mp3' },
      { tr: 'sen',                 de: 'du (informell)',              audio: 'audio/sen.mp3' },
      { tr: 'siz',                 de: 'Sie (formell) / ihr',        audio: 'audio/siz.mp3' },
      { tr: 'Memnun oldum',        de: 'Schön, dich kennenzulernen', audio: 'audio/memnun_oldum.mp3' },
      { tr: 'Ben de memnun oldum', de: 'Freut mich auch',            audio: 'audio/ben_de_memnun_oldum.mp3' },
      { tr: 'İsmim',               de: 'Mein Name ist (alternativ)', audio: 'audio/ismim.mp3' },
    ],
  ...
  'Woher kommst du?': {
    ...
    nachsprech: [
      ...
      { tr: 'Ben Almanya\'danım.', de: 'Ich komme aus Deutschland.',   audio: 'audio/ben_almanyadan_sentence.mp3' },
      { tr: 'Ben Türkiye\'denim.', de: 'Ich komme aus der Türkei.',   audio: 'audio/ben_turkiyedenim.mp3' },
      { tr: 'Vay canına!',         de: 'Wow! / Echt?',                audio: 'audio/vay_canina.mp3' },
      { tr: 'İstanbulluyum.',      de: 'Ich komme aus Istanbul.',     audio: 'audio/istanbulluyum.mp3' },
      { tr: 'Hangi şehirden?',     de: 'Aus welcher Stadt?',          audio: 'audio/hangi_sehirden.mp3' },
    ],
  ...
  'Zahlen 1–10': {
    ...
    nachsprech: [
      { tr: 'bir',   de: 'eins (1)',   audio: 'audio/bir.mp3' },
      { tr: 'iki',   de: 'zwei (2)',   audio: 'audio/iki.mp3' },
      { tr: 'üç',    de: 'drei (3)',   audio: 'audio/uc.mp3' },
      { tr: 'dört',  de: 'vier (4)',   audio: 'audio/dort.mp3' },
      { tr: 'beş',   de: 'fünf (5)',   audio: 'audio/bes.mp3' },
      { tr: 'altı',  de: 'sechs (6)',  audio: 'audio/alti.mp3' },
      { tr: 'yedi',  de: 'sieben (7)', audio: 'audio/yedi.mp3' },
      { tr: 'sekiz', de: 'acht (8)',   audio: 'audio/sekiz.mp3' },
      { tr: 'dokuz', de: 'neun (9)',   audio: 'audio/dokuz.mp3' },
      { tr: 'on',    de: 'zehn (10)',  audio: 'audio/on.mp3' },
    ],
  ...
  'Im Café — Bestellen': {
    ...
    nachsprech: [
      ...
      { tr: 'Kaç para?',         de: 'Wie viel kostet das?',     audio: 'audio/kac_para.mp3' },
      { tr: 'Hesap lütfen.',     de: 'Die Rechnung bitte.',      audio: 'audio/hesap_lutfen.mp3' },
      { tr: 'şekerli',           de: 'mit Zucker',               audio: 'audio/sekerli.mp3' },
      { tr: 'şekersiz',          de: 'ohne Zucker',              audio: 'audio/sekersiz.mp3' },
      { tr: 'ayran',             de: 'Joghurtgetränk',           audio: 'audio/ayran.mp3' },
  ...
  'Wie alt bist du?': {
    ...
    nachsprech: [
      { tr: 'Kaç yaşındasın?',           de: 'Wie alt bist du?',          audio: 'audio/kac_yasindasin.mp3' },
      { tr: 'Ben yirmi beş yaşındayım.', de: 'Ich bin 25 Jahre alt.',     audio: 'audio/ben_yirmi_bes_complete.mp3' },
      { tr: 'on bir',                    de: 'elf (11)',                   audio: 'audio/on_bir.mp3' },
      { tr: 'on beş',                    de: 'fünfzehn (15)',              audio: 'audio/on_bes.mp3' },
      { tr: 'yirmi',                     de: 'zwanzig (20)',               audio: 'audio/yirmi.mp3' },
      { tr: 'otuz',                      de: 'dreißig (30)',               audio: 'audio/otuz.mp3' },
      { tr: 'genç',                      de: 'jung',                       audio: 'audio/genc.mp3' },
    ],
  ...
  'Alles zusammen — erstes Gespräch': {
    ...
    nachsprech: [
      { tr: 'Nasılsın?',            de: 'Wie geht\'s?',                        audio: 'audio/nasilsin.mp3' },
      { tr: 'İyiyim, teşekkürler.', de: 'Mir geht\'s gut, danke.',             audio: 'audio/iyiyim_tesekkurler.mp3' },
      { tr: 'Fena değil',           de: 'Nicht schlecht',                       audio: 'audio/fena_degil.mp3' },
      { tr: 'Sen?',                 de: 'Und du?',                              audio: 'audio/sen_soru.mp3' },
      { tr: 'Memnun oldum!',        de: 'Schön, dich kennenzulernen!',          audio: 'audio/memnun_oldum.mp3' },
      { tr: 'Hoş geldiniz',         de: 'Willkommen!',                          audio: 'audio/hos_geldiniz.mp3' },
      { tr: 'Görüşürüz',            de: 'Bis bald!',                            audio: 'audio/gorusuruz.mp3' },
    ],
  ...
  'Zahlen 11–100': {
    ...
    nachsprech: [
      { tr: 'yirmi',   de: 'zwanzig (20)',    audio: 'audio/yirmi.mp3' },
      { tr: 'otuz',    de: 'dreißig (30)',    audio: 'audio/otuz.mp3' },
      { tr: 'kırk',    de: 'vierzig (40)',    audio: 'audio/kirk.mp3' },
      { tr: 'elli',    de: 'fünfzig (50)',    audio: 'audio/elli.mp3' },
      { tr: 'altmış',  de: 'sechzig (60)',    audio: 'audio/altmis.mp3' },
      { tr: 'yetmiş',  de: 'siebzig (70)',    audio: 'audio/yetmis.mp3' },
      { tr: 'seksen',  de: 'achtzig (80)',    audio: 'audio/seksen.mp3' },
      { tr: 'doksan',  de: 'neunzig (90)',    audio: 'audio/doksan.mp3' },
      { tr: 'yüz',     de: 'hundert (100)',   audio: 'audio/yuz.mp3' },
    ],
  ...
  'Familienmitglieder': {
    ...
    nachsprech: [
      { tr: 'anne',     de: 'Mutter',           audio: 'audio/anne.mp3' },
      { tr: 'baba',     de: 'Vater',            audio: 'audio/baba.mp3' },
      { tr: 'abla',     de: 'ältere Schwester', audio: 'audio/abla.mp3' },
      { tr: 'abi',      de: 'älterer Bruder',   audio: 'audio/abi.mp3' },
      { tr: 'kardeş',   de: 'Geschwister',      audio: 'audio/kardes.mp3' },
      { tr: 'dede',     de: 'Opa',              audio: 'audio/dede.mp3' },
      { tr: 'anneanne', de: 'Oma (mütterlich)', audio: 'audio/anneanne.mp3' },
      { tr: 'aile',   de: 'Familie',          audio: 'audio/aile.mp3' },
    ],
  ...
  'Farben lernen': {
    ...
    nachsprech: [
      { tr: 'kırmızı',    de: 'rot',           audio: 'audio/kirmizi.mp3' },
      { tr: 'mavi',       de: 'blau',          audio: 'audio/mavi.mp3' },
      { tr: 'yeşil',      de: 'grün',          audio: 'audio/yesil.mp3' },
      { tr: 'sarı',       de: 'gelb',          audio: 'audio/sari.mp3' },
      { tr: 'beyaz',      de: 'weiß',          audio: 'audio/beyaz.mp3' },
      { tr: 'siyah',      de: 'schwarz',       audio: 'audio/siyah.mp3' },
      { tr: 'turuncu',    de: 'orange',        audio: 'audio/turuncu.mp3' },
      { tr: 'mor',        de: 'lila / violett', audio: 'audio/mor.mp3' },
    ],
  ...
  'Kleidung benennen': {
    ...
    nachsprech: [
      { tr: 'tişört',             de: 'T-Shirt',                   audio: 'audio/tisort.mp3' },
      { tr: 'gömlek',             de: 'Hemd / Bluse',              audio: 'audio/gomlek.mp3' },
      { tr: 'pantolon',           de: 'Hose',                      audio: 'audio/pantolon.mp3' },
      { tr: 'elbise',             de: 'Kleid',                     audio: 'audio/elbise.mp3' },
      { tr: 'ceket',              de: 'Jacke',                     audio: 'audio/ceket.mp3' },
      { tr: 'ayakkabı',           de: 'Schuhe',                    audio: 'audio/ayakkabi.mp3' },
      { tr: 'çanta',              de: 'Tasche',                    audio: 'audio/canta.mp3' },
      { tr: 'Deneyebilir miyim?', de: 'Kann ich es anprobieren?',  audio: 'audio/deneyebilir_miyim.mp3' },
    ],
  ...
  'Die Uhrzeit': {
    ...
    nachsprech: [
      { tr: 'Saat kaç?',       de: 'Wie spät ist es?',    audio: 'audio/saat_kac.mp3' },
      { tr: 'Saat bir.',       de: 'Es ist ein Uhr.',     audio: 'audio/saat_bir.mp3' },
      { tr: 'Saat iki buçuk.', de: 'Es ist halb drei.',   audio: 'audio/saat_iki_bucuk.mp3' },
      { tr: 'sabah',           de: 'Morgen / morgens',    audio: 'audio/sabah.mp3' },
      { tr: 'akşam',           de: 'Abend / abends',      audio: 'audio/aksam.mp3' },
      { tr: 'gece',            de: 'Nacht / nachts',      audio: 'audio/gece.mp3' },
      { tr: 'dakika',          de: 'Minute',              audio: 'audio/dakika.mp3' },
      { tr: 'Saat kaçta?',     de: 'Um wie viel Uhr?',   audio: 'audio/saat_kacta.mp3' },
    ],
  ...
  'Datum & Wochentage': {
    ...
    nachsprech: [
      { tr: 'Pazartesi',  de: 'Montag',     audio: 'audio/pazartesi.mp3' },
      { tr: 'Salı',       de: 'Dienstag',   audio: 'audio/sali.mp3' },
      { tr: 'Çarşamba',   de: 'Mittwoch',   audio: 'audio/carsamba.mp3' },
      { tr: 'Perşembe',   de: 'Donnerstag', audio: 'audio/persembe.mp3' },
      { tr: 'Cuma',       de: 'Freitag',    audio: 'audio/cuma.mp3' },
      { tr: 'Cumartesi',  de: 'Samstag',    audio: 'audio/cumartesi.mp3' },
      { tr: 'Pazar',      de: 'Sonntag',    audio: 'audio/pazar.mp3' },
      { tr: 'bugün',      de: 'heute',      audio: 'audio/bugun.mp3' },
    ],
  ...
  'Monate & Jahreszeiten': {
    ...
    nachsprech: [
      { tr: 'Ocak',     de: 'Januar',    audio: 'audio/ocak.mp3' },
      { tr: 'Mart',     de: 'März',      audio: 'audio/mart.mp3' },
      { tr: 'Haziran',  de: 'Juni',      audio: 'audio/haziran.mp3' },
      { tr: 'Temmuz',   de: 'Juli',      audio: 'audio/temmuz.mp3' },
      { tr: 'Eylül',    de: 'September', audio: 'audio/eylul.mp3' },
      { tr: 'Aralık',   de: 'Dezember',  audio: 'audio/aralik.mp3' },
      { tr: 'ilkbahar', de: 'Frühling',  audio: 'audio/ilkbahar.mp3' },
      { tr: 'yaz',      de: 'Sommer',    audio: 'audio/yaz.mp3' },
    ],
  ...
  'Lebensmittel & Zutaten': {
    ...
    nachsprech: [
      { tr: 'ekmek',   de: 'Brot',      audio: 'audio/ekmek.mp3' },
      { tr: 'süt',     de: 'Milch',     audio: 'audio/sut.mp3' },
      { tr: 'peynir',  de: 'Käse',      audio: 'audio/peynir.mp3' },
      { tr: 'yumurta', de: 'Ei',        audio: 'audio/yumurta.mp3' },
      { tr: 'et',      de: 'Fleisch',   audio: 'audio/et.mp3' },
      { tr: 'tavuk',   de: 'Hühnchen',  audio: 'audio/tavuk.mp3' },
      { tr: 'domates', de: 'Tomate',    audio: 'audio/domates.mp3' },
      { tr: 'elma',    de: 'Apfel',     audio: 'audio/elma.mp3' },
    ],
  ...
  'Essen bestellen': {
    ...
    nachsprech: [
      { tr: 'menü',                  de: 'Speisekarte',          audio: 'audio/menu.mp3' },
      { tr: 'çorba',                 de: 'Suppe',                audio: 'audio/corba.mp3' },
      { tr: 'salata',                de: 'Salat',                audio: 'audio/salata.mp3' },
      { tr: 'kebap',                 de: 'Kebab',                audio: 'audio/kebap.mp3' },
      { tr: 'tatlı',                 de: 'Dessert / süß',        audio: 'audio/tatli.mp3' },
      { tr: 'Afiyet olsun!',         de: 'Guten Appetit!',       audio: 'audio/afiyet_olsun.mp3' },
      { tr: 'Ne tavsiye edersiniz?', de: 'Was empfehlen Sie?',   audio: 'audio/ne_tavsiye_edersiniz.mp3' },
      { tr: 'Elinize sağlık',        de: 'Danke für das Essen',  audio: 'audio/elinize_saglik.mp3' },
    ],
  ...
  'Wetter beschreiben': {
    ...
    nachsprech: [
      { tr: 'Hava nasıl?', de: 'Wie ist das Wetter?', audio: 'audio/hava_nasil.mp3' },
      { tr: 'güneşli',     de: 'sonnig',               audio: 'audio/gunесli.mp3' },
      { tr: 'yağmurlu',    de: 'regnerisch',            audio: 'audio/yagmurlu.mp3' },
      { tr: 'bulutlu',     de: 'bewölkt',               audio: 'audio/bulutlu.mp3' },
      { tr: 'sıcak',       de: 'heiß / warm',           audio: 'audio/sicak.mp3' },
      { tr: 'soğuk',       de: 'kalt',                  audio: 'audio/soguk.mp3' },
      { tr: 'karlı',       de: 'schneeig',              audio: 'audio/karli.mp3' },
      { tr: 'rüzgarlı',    de: 'windig',                audio: 'audio/ruzgarli.mp3' },
    ],
  ...
  'Körper & Beschwerden': {
    ...
    nachsprech: [
      { tr: 'baş',             de: 'Kopf',                 audio: 'audio/bas.mp3' },
      { tr: 'göz',             de: 'Auge',                 audio: 'audio/goz.mp3' },
      { tr: 'kulak',           de: 'Ohr',                  audio: 'audio/kulak.mp3' },
      { tr: 'diş',             de: 'Zahn',                 audio: 'audio/dis.mp3' },
      { tr: 'el',              de: 'Hand',                 audio: 'audio/el.mp3' },
      { tr: 'kol',             de: 'Arm',                  audio: 'audio/kol.mp3' },
      { tr: 'ayak',            de: 'Fuß',                  audio: 'audio/ayak.mp3' },
      { tr: 'Başım ağrıyor.',  de: 'Mein Kopf tut weh.',   audio: 'audio/basim_agriyor.mp3' },
    ],
  ...
  'Das Haus & Zimmer': {
    ...
    nachsprech: [
      { tr: 'ev',          de: 'Haus',          audio: 'audio/ev.mp3' },
      { tr: 'mutfak',      de: 'Küche',         audio: 'audio/mutfak.mp3' },
      { tr: 'banyo',       de: 'Badezimmer',    audio: 'audio/banyo.mp3' },
      { tr: 'salon',       de: 'Wohnzimmer',    audio: 'audio/salon.mp3' },
      { tr: 'yatak odası', de: 'Schlafzimmer',  audio: 'audio/yatak_odasi.mp3' },
      { tr: 'masa',        de: 'Tisch',         audio: 'audio/masa.mp3' },
      { tr: 'kapı',        de: 'Tür',           audio: 'audio/kapi.mp3' },
      { tr: 'pencere',     de: 'Fenster',       audio: 'audio/pencere.mp3' },
    ],
  ...
  'Verben im Präsens': {
    ...
    nachsprech: [
      { tr: 'gidiyorum',   de: 'ich gehe',       audio: 'audio/gidiyorum.mp3' },
      { tr: 'geliyorum',   de: 'ich komme',      audio: 'audio/geliyorum.mp3' },
      { tr: 'yiyorum',     de: 'ich esse',       audio: 'audio/yiyorum.mp3' },
      { tr: 'içiyorum',    de: 'ich trinke',     audio: 'audio/iciyorum.mp3' },
      { tr: 'yapıyorum',   de: 'ich mache',      audio: 'audio/yapiyorum.mp3' },
      { tr: 'seviyorum',   de: 'ich liebe/mag',  audio: 'audio/seviyorum.mp3' },
      { tr: 'öğreniyorum', de: 'ich lerne',      audio: 'audio/ogreniyorum.mp3' },
      { tr: 'çalışıyorum', de: 'ich arbeite',    audio: 'audio/calisiyorum.mp3' },
    ],
  ...
  'Verneinung & Fragen': {
    ...
    nachsprech: [
      { tr: 'değil',        de: 'nicht / kein',         audio: 'audio/degil.mp3' },
      { tr: 'yok',          de: 'es gibt nicht',        audio: 'audio/yok.mp3' },
      { tr: 'Anlamıyorum.', de: 'Ich verstehe nicht.',  audio: 'audio/anlamiyorum.mp3' },
      { tr: 'Bilmiyorum.',  de: 'Ich weiß nicht.',      audio: 'audio/bilmiyorum.mp3' },
      { tr: 'Nerede?',      de: 'Wo?',                  audio: 'audio/nerede.mp3' },
      { tr: 'Ne zaman?',    de: 'Wann?',                audio: 'audio/ne_zaman.mp3' },
      { tr: 'Neden?',       de: 'Warum?',               audio: 'audio/neden.mp3' },
      { tr: 'Kim?',         de: 'Wer?',                 audio: 'audio/kim.mp3' },
    ],
  ...
  'Adjektive & Beschreibungen': {
    ...
    nachsprech: [
      ...
      { tr: 'büyük',   de: 'groß',               audio: 'audio/buyuk.mp3' },
      { tr: 'küçük',   de: 'klein',              audio: 'audio/kucuk.mp3' },
      { tr: 'yeni',    de: 'neu',                audio: 'audio/yeni.mp3' },
      { tr: 'eski',    de: 'alt (Dinge)',         audio: 'audio/eski.mp3' },
      { tr: 'iyi',     de: 'gut',                audio: 'audio/iyi.mp3' },
      { tr: 'kötü',    de: 'schlecht',           audio: 'audio/kotu.mp3' },
      { tr: 'pahalı',  de: 'teuer',              audio: 'audio/pahali.mp3' },
    ],
  ...
  'Beziehungen & Freunde': {
    ...
    nachsprech: [
      { tr: 'arkadaş',         de: 'Freund / Freundin',        audio: 'audio/arkadas.mp3' },
      { tr: 'komşu',           de: 'Nachbar / Nachbarin',      audio: 'audio/komsu.mp3' },
      { tr: 'evli',            de: 'verheiratet',              audio: 'audio/evli.mp3' },
      { tr: 'bekar',           de: 'ledig',                    audio: 'audio/bekar.mp3' },
      { tr: 'sevmek',          de: 'lieben / mögen',           audio: 'audio/sevmek.mp3' },
      { tr: 'özlemek',         de: 'vermissen',                audio: 'audio/ozlemek.mp3' },
      { tr: 'Seni özledim.',   de: 'Ich habe dich vermisst.',  audio: 'audio/seni_ozledim.mp3' },
      { tr: 'Seni seviyorum.', de: 'Ich liebe dich.',          audio: 'audio/seni_seviyorum.mp3' },
    ],
  ...
  'Eigenschaften & Charakter': {
    ...
    nachsprech: [
      { tr: 'zeki',      de: 'intelligent / klug',  audio: 'audio/zeki.mp3' },
      { tr: 'kibar',     de: 'höflich / nett',      audio: 'audio/kibar.mp3' },
      { tr: 'çalışkan',  de: 'fleißig',             audio: 'audio/caliskan.mp3' },
      { tr: 'tembel',    de: 'faul',                audio: 'audio/tembel.mp3' },
      { tr: 'sabırlı',   de: 'geduldig',            audio: 'audio/sabirli.mp3' },
      { tr: 'dürüst',    de: 'ehrlich',             audio: 'audio/durust.mp3' },
      { tr: 'güvenilir', de: 'zuverlässig',         audio: 'audio/guvenilir.mp3' },
      { tr: 'cesur',     de: 'mutig',               audio: 'audio/cesur.mp3' },
    ],
  ...
  'Ordinalzahlen & Mengen': {
    ...
    nachsprech: [
      { tr: 'birinci',  de: 'erste(r/s)',       audio: 'audio/birinci.mp3' },
      { tr: 'ikinci',   de: 'zweite(r/s)',      audio: 'audio/ikinci.mp3' },
      { tr: 'üçüncü',   de: 'dritte(r/s)',      audio: 'audio/ucuncu.mp3' },
      { tr: 'dördüncü', de: 'vierte(r/s)',      audio: 'audio/dorduncu.mp3' },
      { tr: 'beşinci',  de: 'fünfte(r/s)',      audio: 'audio/besinci.mp3' },
      { tr: 'tane',     de: 'Stück (Zählwort)', audio: 'audio/tane.mp3' },
      { tr: 'yarım',    de: 'ein halb',         audio: 'audio/yarim.mp3' },
      { tr: 'birkaç',   de: 'ein paar / einige', audio: 'audio/birkac.mp3' },
    ],
  ...
  'Türkische Gerichte': {
    ...
    nachsprech: [
      { tr: 'döner',            de: 'Döner',                    audio: 'audio/doner.mp3' },
      { tr: 'köfte',            de: 'Hackfleischbällchen',      audio: 'audio/kofte.mp3' },
      { tr: 'baklava',          de: 'Baklava (süßes Gebäck)',   audio: 'audio/baklava.mp3' },
      { tr: 'ayran',            de: 'Joghurtgetränk (gesalzen)', audio: 'audio/ayran.mp3' },
      { tr: 'mercimek çorbası', de: 'Linsensuppe',              audio: 'audio/mercimek_corbasi.mp3' },
      { tr: 'lahmacun',         de: 'Türkische Dünnbrot-Pizza', audio: 'audio/lahmacun.mp3' },
      { tr: 'simit',            de: 'Sesamkringel',             audio: 'audio/simit.mp3' },
      { tr: 'hesap',            de: 'Rechnung',                 audio: 'audio/hesap.mp3' },
    ],
  ...
  'Möbel & Einrichtung': {
    ...
    nachsprech: [
      { tr: 'koltuk',    de: 'Sessel / Sofa',  audio: 'audio/koltuk.mp3' },
      { tr: 'masa',      de: 'Tisch',          audio: 'audio/masa.mp3' },
      { tr: 'sandalye',  de: 'Stuhl',          audio: 'audio/sandalye.mp3' },
      { tr: 'yatak',     de: 'Bett',           audio: 'audio/yatak.mp3' },
      { tr: 'dolap',     de: 'Schrank',        audio: 'audio/dolap.mp3' },
      { tr: 'pencere',   de: 'Fenster',        audio: 'audio/pencere.mp3' },
      { tr: 'kapı',      de: 'Tür',            audio: 'audio/kapi.mp3' },
      { tr: 'buzdolabı', de: 'Kühlschrank',    audio: 'audio/buzdolabi.mp3' },
    ],
  ...
  'In der Stadt & Verkehr': {
    ...
    nachsprech: [
      { tr: 'market',   de: 'Supermarkt',          audio: 'audio/market.mp3' },
      { tr: 'hastane',  de: 'Krankenhaus',         audio: 'audio/hastane.mp3' },
      { tr: 'eczane',   de: 'Apotheke',            audio: 'audio/eczane.mp3' },
      { tr: 'otobüs',   de: 'Bus',                 audio: 'audio/otobus.mp3' },
      { tr: 'metro',    de: 'U-Bahn',              audio: 'audio/metro.mp3' },
      { tr: 'taksi',    de: 'Taxi',                audio: 'audio/taksi.mp3' },
      { tr: 'sağa',     de: 'rechts (Richtung)',   audio: 'audio/saga.mp3' },
      { tr: 'sola',     de: 'links (Richtung)',    audio: 'audio/sola.mp3' },
    ],
  ...
  'Jahreszeiten & Aktivitäten': {
    ...
    nachsprech: [
      { tr: 'ilkbahar',      de: 'Frühling',               audio: 'audio/ilkbahar.mp3' },
      { tr: 'yaz',           de: 'Sommer',                 audio: 'audio/yaz.mp3' },
      { tr: 'sonbahar',      de: 'Herbst',                 audio: 'audio/sonbahar.mp3' },
      { tr: 'kış',           de: 'Winter',                 audio: 'audio/kis.mp3' },
      { tr: 'yüzmek',        de: 'schwimmen',              audio: 'audio/yuzmek.mp3' },
      { tr: 'sıcak',         de: 'heiß / warm',            audio: 'audio/sicak.mp3' },
      { tr: 'soğuk',         de: 'kalt',                   audio: 'audio/soguk.mp3' },
      { tr: 'tatile gitmek', de: 'in den Urlaub fahren',   audio: 'audio/tatile_gitmek.mp3' },
    ],
  ...
  'Gefühle & Emotionen': {
    ...
    nachsprech: [
      { tr: 'mutlu',     de: 'glücklich / froh',       audio: 'audio/mutlu.mp3' },
      { tr: 'üzgün',     de: 'traurig',                audio: 'audio/uzgun.mp3' },
      { tr: 'kızgın',    de: 'wütend / ärgerlich',     audio: 'audio/kizgin.mp3' },
      { tr: 'yorgun',    de: 'müde',                   audio: 'audio/yorgun.mp3' },
      { tr: 'heyecanlı', de: 'aufgeregt / begeistert', audio: 'audio/heyecanli.mp3' },
      { tr: 'rahat',     de: 'entspannt / ruhig',      audio: 'audio/rahat.mp3' },
      { tr: 'stresli',   de: 'gestresst',              audio: 'audio/stresli.mp3' },
      { tr: 'özlemek',   de: 'vermissen',              audio: 'audio/ozlemek.mp3' },
    ],
  ...
  'Beim Arzt': {
    ...
    nachsprech: [
      { tr: 'doktor',      de: 'Arzt / Ärztin',            audio: 'audio/doktor.mp3' },
      { tr: 'ağrı',        de: 'Schmerz',                  audio: 'audio/agri.mp3' },
      { tr: 'ateş',        de: 'Fieber',                   audio: 'audio/ates.mp3' },
      { tr: 'öksürük',     de: 'Husten',                   audio: 'audio/oksuruk.mp3' },
      { tr: 'nezle',       de: 'Erkältung / Schnupfen',    audio: 'audio/nezle.mp3' },
      { tr: 'ilaç',        de: 'Medikament',               audio: 'audio/ilac.mp3' },
      { tr: 'reçete',      de: 'Rezept',                   audio: 'audio/recete.mp3' },
      { tr: 'muayene',     de: 'Untersuchung / Arztbesuch', audio: 'audio/muayene.mp3' },
    ],
  ...
  'Possessivsuffixe': {
    ...
    nachsprech: [
      { tr: 'evim',      de: 'mein Haus',                   audio: 'audio/evim.mp3' },
      { tr: 'evin',      de: 'dein Haus',                   audio: 'audio/evin.mp3' },
      { tr: 'arabam',    de: 'mein Auto',                   audio: 'audio/arabam.mp3' },
      { tr: 'kitabım',   de: 'mein Buch',                   audio: 'audio/kitabim.mp3' },
      { tr: 'adım',      de: 'mein Name',                   audio: 'audio/adim.mp3' },
      { tr: 'ailem',     de: 'meine Familie',               audio: 'audio/ailem.mp3' },
      { tr: 'kardeşim',  de: 'mein Geschwisterteil',        audio: 'audio/kardesim.mp3' },
      { tr: 'babam',     de: 'mein Vater',                  audio: 'audio/babam.mp3' },
    ],
  ...
  'Lokalkasus: -de/-da/-den/-dan': {
    ...
    nachsprech: [
      { tr: 'evde',          de: 'zu Hause / im Haus',   audio: 'audio/evde.mp3' },
      { tr: 'okulda',        de: 'in der Schule',        audio: 'audio/okulda.mp3' },
      { tr: 'markette',      de: 'im Supermarkt',        audio: 'audio/markette.mp3' },
      { tr: 'evden',         de: 'von zu Hause',         audio: 'audio/evden.mp3' },
      { tr: 'okuldan',       de: 'von der Schule',       audio: 'audio/okuldan.mp3' },
      { tr: 'Almanya\'dan',  de: 'aus Deutschland',      audio: 'audio/almanyadan.mp3' },
      { tr: 'nerede',        de: 'wo?',                  audio: 'audio/nerede.mp3' },
      { tr: 'nereden',       de: 'woher?',               audio: 'audio/nereden.mp3' },
    ],
